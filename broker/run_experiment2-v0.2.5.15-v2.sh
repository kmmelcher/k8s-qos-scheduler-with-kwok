...
bash run_experiment.sh workloads/workload-exp2-very-high-contention-aggregate-replication4-v2.csv 1800 1 1 >> log_experiment2_30s
...
bash run_experiment.sh workloads/workload-exp2-no-contention-aggregate-replication4-v2.csv 1800 1 1 >> log_experiment2_30s
...
bash run_experiment.sh workloads/workload-exp2-medium-contention-aggregate-replication4-v2.csv 1800 1 1 >> log_experiment2_300s
...
bash run_experiment.sh workloads/workload-exp2-higher-contention-aggregate-replication4-v2.csv 1800 1 1 >> log_experiment2_300s
...
bash run_experiment.sh workloads/workload-exp2-no-contention-aggregate-replication4-v2.csv 1800 1 1 >> log_experiment2_300s
