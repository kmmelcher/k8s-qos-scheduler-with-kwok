...
rm $HOME/serviceapplication.dat
...
SCHPOD=`kubectl get pods -n kube-system | grep -v NAME  | grep "kube-scheduler" | awk '{print $1}'`
...
kubectl cp kube-system/$SCHPOD:/metrics.log data/$OUTPUT_BASEx
