...
cd ../cluster
bash configure_cluster.sh qos-driven-scheduler:v0.2.5.14 1 30s 300s priority
cd ../broker

sleep 60

bash run_experiment.sh workloads/workload-exp1-medium-contention-average-replication4-v2.csv 1800 1 1 >> log_experiment1_30s

sleep 60

cd ../cluster
bash configure_cluster.sh qos-driven-scheduler:v0.2.5.14 2 30s 300s qos-driven
cd ../broker
...
bash run_experiment.sh workloads/workload-exp1-medium-contention-independent-replication4-v2.csv 1800 1 1 >> log_experiment1_30s
...
bash run_experiment.sh workloads/workload-exp1-high-contention-average-replication4-v2.csv 1800 1 1 >> log_experiment1_30s
...
bash run_experiment.sh workloads/workload-exp1-high-contention-independent-replication4-v2.csv 1800 1 1 >> log_experiment1_30s
...
bash run_experiment.sh workloads/workload-exp1-no-contention-average-replication4-v2.csv 1800 1 1 >> log_experiment1_30s
...
bash run_experiment.sh workloads/workload-exp1-no-contention-concurrent-replication4-v2.csv 1800 1 1 >> log_experiment1_30s
...
bash run_experiment.sh workloads/workload-exp1-no-contention-independent-replication4-v2.csv 1800 1 1 >> log_experiment1_30s
